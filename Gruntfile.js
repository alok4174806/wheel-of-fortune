module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		jshint: {
		source: ['Gruntfile.js','!source/scripts/vendor/**','source/scripts/{,*/}*.js'],
		test: ['test/**/*.js'],
		reporterOutput:"",
		force:true
	},
			...
			compile: {
				options: {
					data: {
						...
						baseUrl: '/',
						initialRoute: 'wheel/data:spreadsheet,1AOFkRxYNnEwCbKJxobsC0u_7cYBmwlADfbvHUQ8VS5k,alok,kumar'
					}
				},
				files: {
